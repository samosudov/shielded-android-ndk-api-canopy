...
Java_work_samosudov_rustlib_RustAPI_initModel(
        JNIEnv *env,
        jobject /* this */,
...
Java_work_samosudov_rustlib_RustAPI_test(
        JNIEnv *env,
        jobject,
        jbyteArray d) {
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_cm(
        JNIEnv *env,
        jobject,
        jstring d,
        jstring pkd,
...
JNIEXPORT jbyteArray JNICALL
Java_work_samosudov_rustlib_RustAPI_greeting(
        JNIEnv *env,
        jobject,
        jstring esk,
        jstring d,
...
JNIEXPORT jbyteArray JNICALL
Java_work_samosudov_rustlib_RustAPI_bsig(
        JNIEnv *env,
        jobject,
        jstring v,
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_kagree(
        JNIEnv *env,
        jobject,
        jstring epk,
        jstring ivk) {
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_ivkToPdk(
        JNIEnv *env,
        jobject,
        jstring ivk,
        jstring d) {
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_uncommitted(
        JNIEnv *env,
        jobject) {
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_computeNf(
        JNIEnv *env,
        jobject,
        jstring d,
        jstring pkd,
...
JNIEXPORT jstring JNICALL
Java_work_samosudov_rustlib_RustAPI_proveContextInit(
        JNIEnv *env,
        jobject) {
...
JNIEXPORT jbyteArray JNICALL
Java_work_samosudov_rustlib_RustAPI_spendProof(
        JNIEnv *env,
        jobject,
        jstring ak,
        jstring nsk,
...
JNIEXPORT jbyteArray JNICALL
Java_work_samosudov_rustlib_RustAPI_spendSig(
        JNIEnv *env,
        jobject,
        jstring ask,
        jstring alpha,
